...
void VideoRendererGL::registerVideoCallbacks(vlc_player_t* object)
{
    ...
    var_Create( object, "vgl-opaque", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-setup-cb", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-cleanup-cb", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-resize-cb", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-swap-cb", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-make-current-cb", VLC_VAR_ADDRESS );
    var_Create( object, "vgl-get-proc-address-cb", VLC_VAR_ADDRESS );

    var_SetAddress( object, "vgl-opaque", this );
    var_SetAddress( object, "vgl-setup-cb", (void*)&VideoRendererGL::setup_cb );
    var_SetAddress( object, "vgl-cleanup-cb", (void*)&VideoRendererGL::cleanup_cb );
    var_SetAddress( object, "vgl-resize-cb", (void*)&VideoRendererGL::resize_cb );
    var_SetAddress( object, "vgl-swap-cb", (void*)&VideoRendererGL::swap_cb );
    var_SetAddress( object, "vgl-make-current-cb", (void*)&VideoRendererGL::make_current_cb );
    var_SetAddress( object, "vgl-get-proc-address-cb", (void*)&VideoRendererGL::get_proc_address_cb );
}
